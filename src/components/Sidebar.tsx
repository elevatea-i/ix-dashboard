        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="h-16 px-6 border-b border-white/10 flex items-center justify-between shrink-0">
            <div className="flex items-center space-x-3">
              <div className="w-9 h-9 rounded-lg bg-elevated-gold text-enchanted-green flex items-center justify-center shrink-0 shadow-sm">
                <span className="font-serif font-bold text-lg">IX</span>
              </div>
              <div>
