...
export default function GastoFormModal({
  ...
  return (
    <div id="gasto-form-modal-container" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-enchanted-green/80 dark:bg-black/80 backdrop-blur-sm">
      <div id="gasto-form-modal-card" className="bg-light-ivory dark:bg-[#051A14] w-full max-w-3xl rounded-lg shadow-2xl border border-elevated-gold/30 overflow-hidden flex flex-col max-h-[95vh]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-white/50 dark:bg-black/20 rounded-lg p-4 border border-enchanted-green/10 dark:border-light-ivory/10 space-y-4">
          ...
          <div className="bg-white/50 dark:bg-black/20 rounded-lg p-4 border border-enchanted-green/10 dark:border-light-ivory/10 space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-6 pr-3 py-2 bg-light-ivory/40 dark:bg-[#070D0C]/40 border rounded text-sm text-enchanted-green dark:text-light-ivory font-mono focus:outline-none focus:border-elevated-gold dark:focus:border-elevated-gold transition-colors ${
                      errors.subtotal ? 'border-cranberry' : 'border-enchanted-green/20 dark:border-light-ivory/20'
                    }`}
                  />
                </div>
                {errors.subtotal && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className={`w-full pl-6 pr-3 py-2 bg-light-ivory/40 dark:bg-[#070D0C]/40 border rounded text-sm text-enchanted-green dark:text-light-ivory font-mono focus:outline-none focus:border-elevated-gold dark:focus:border-elevated-gold transition-colors ${
                      errors.iva ? 'border-cranberry' : 'border-enchanted-green/20 dark:border-light-ivory/20'
                    }`}
                  />
                </div>
                {errors.iva && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full pl-6 pr-3 py-2 bg-light-ivory/40 dark:bg-[#070D0C]/40 border border-enchanted-green/20 dark:border-light-ivory/20 rounded text-sm text-enchanted-green dark:text-light-ivory font-mono focus:outline-none focus:border-elevated-gold dark:focus:border-elevated-gold transition-colors"
                  />
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3.5 bg-enchanted-green/5 dark:bg-white/5 rounded-lg border border-enchanted-green/10 dark:border-white/5">
              <div>
                <p className="text-xs font-semibold text-rocky-gray dark:text-rose-linen/60">Total Recalculado en Tiempo Real</p>
                <p className="text-[10px] text-rocky-gray/80 dark:text-rose-linen/40 mt-0.5">Subtotal + IVA - Retención ISR - Retención IVA</p>
              </div>
